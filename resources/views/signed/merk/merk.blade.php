            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card border-0 shadow rounded">
                        <div class="card-body">
                            <form action="{{ route('merk.search') }}" method="GET">
                                @csrf
                                @method('GET')
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <input type="text"
                                                    ...
                                                    name="search" value="" placeholder="Cari merk">
                            ...
                            {{-- <!-- <a href="{{ route('merk.create.bulk') }}" class="btn btn-md btn-success mb-3 btn-sm">Import Dari Excel</a> --> --}}
                            <div class="table-responsive">
                                <table class="table table-stripped table-hover">
                                    <thead>
                                        <tr style="color:#F37A29;">
                                            <th class="text-center" scope="col">No.</th>
                                            <th class="text-center" scope="col">Nama Merk</th>
