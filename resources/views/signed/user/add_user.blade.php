                        ...
                        <div class="card-body">
                            <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="mb-3 mt-3 form-control @error('name') is-invalid @enderror"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email"
                                        class="mb-3 mt-3 form-control @error('email') is-invalid @enderror" name="email"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password"
                                        ...
                                        name="password" value="" placeholder="Masukkan Kata Sandi">
